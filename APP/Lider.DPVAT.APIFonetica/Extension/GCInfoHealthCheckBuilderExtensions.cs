...
namespace Lider.DPVAT.APIDesvincularSinistro.UI.Extension
{
    ...
    public class GCInfoHealthCheck : IHealthCheck
    {
...

        {
            ...
            { "Allocated", allocated / 1024L / 1024L }
            ...
            return Task.FromResult(new HealthCheckResult(result, description: DateTime.Now.ToString(), data: data));
